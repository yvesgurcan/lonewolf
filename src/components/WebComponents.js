...
export function View(props) {
    return <div {...props} style={{ ...Styles.Boilerplate, ...props.style }} />;
}

export function Header1(props) {
    return (
        <h1 style={{ ...Styles.Boilerplate, ...Styles.H1 }}>
            {props.children}
        </h1>
    );
}
...
export class TextWithInputFont extends Component {
    render() {
        return (
            <Text
                {...this.props}
                style={{ ...Styles.TextWithInputFont, ...this.props.style }}
            />
        );
    }
}
    ...
    render() {
        return (
            <View
                style={{
                    userSelect: 'none',
                    ...(this.props.noMargin ? null : Styles.LabelContainer),
                }}
...
export class TextInput extends Component {
    render() {
        return (
            <input
                {...this.props}
                style={{ ...Styles.Boilerplate, ...this.props.style }}
            />
        );
    }
}
...
export function Picker(props) {
    return (
        <select
            {...props}
            style={{ ...Styles.Boilerplate, ...Styles.Select, ...props.style }}
        />
    );
}
